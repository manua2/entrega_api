...
app.post('/getMatches', getMatches)
app.post('/createMatch', createMatch)
app.get('/match/:id', getMatch)
app.post('/playMatch', playMatch)

mongoose.connect(process.env.MONGODB_URI || databaseConnectionString, { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true }, (error) => {
    if (error) {
